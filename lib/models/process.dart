...
class Process {
  ...
  factory Process.fromJson(Map<String, dynamic> json) {
   ...
   nombre_proceso: (json['name'] as String?) ?? (json['nombre_proceso'] as String), // CORREGIDO
  ...
  Process copyWith({
    String? id,
    String? nombre_proceso, // <-- Debe coincidir con 'nombre_proceso' de tu clase
    ...
    return Process(
      id: id ?? this.id,
      nombre_proceso: nombre_proceso ?? this.nombre_proceso, // Usar el parámetro 'nombre_proceso'
