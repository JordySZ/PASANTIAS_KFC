...
class ApiService {
  ...
  Future<List<ListaDatos>> getLists(String processName) async {
    ...
    try {
      final response = await http.get(Uri.parse('$_baseUrl/procesos/${Uri.encodeComponent(processName)}/lists')); // Usar encodeComponent
  ...
  Future<ListaDatos?> createList(String processName, ListaDatos list) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('$_baseUrl/procesos/${Uri.encodeComponent(processName)}/lists'), // Usar encodeComponent
  ...
  Future<ListaDatos?> updateList(String processName, ListaDatos list) async {
    ...
    try {
      final response = await http.put(
        Uri.parse('$_baseUrl/procesos/${Uri.encodeComponent(processName)}/lists/${list.id}'), // Usar encodeComponent
        headers: {'Content-Type': 'application/json'},
        body: json.encode(list.toMap()),
      );
  ...
  Future<List<Tarjeta>> getCards(String collectionName) async {
    ...
    try {
      final response = await http.get(Uri.parse('$_baseUrl/procesos/${Uri.encodeComponent(collectionName)}/cards')); // Usar encodeComponent
  ...
  Future<Tarjeta?> createCard(String collectionName, Tarjeta card) async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('$_baseUrl/procesos/${Uri.encodeComponent(collectionName)}/cards'), // Usar encodeComponent
        headers: {'Content-Type': 'application/json'},
  ...
  Future<Tarjeta?> updateCard(String collectionName, Tarjeta card) async {
    ...
    try {
      ...
      final response = await http.put(
        Uri.parse('$_baseUrl/procesos/${Uri.encodeComponent(collectionName)}/cards/${card.id}'), // Usar encodeComponent
        headers: {'Content-Type': 'application/json'},
        body: json.encode(body),
      );
  ...
  Future<bool> deleteCard(String collectionName, String cardId) async {
    ...
    try {
      final response = await http.delete(Uri.parse('$_baseUrl/procesos/${Uri.encodeComponent(collectionName)}/cards/$cardId')); // Usar encodeComponent
  ...
  Future<bool> deleteProcess(String processName) async {
    ...
    try {
      final response = await http.delete(
        Uri.parse('$_baseUrl/procesos/${Uri.encodeComponent(processName)}'), // Usar encodeComponent
        headers: <String, String>{
          'Content-Type': 'application/json; charset=UTF-8',
        },
      );
