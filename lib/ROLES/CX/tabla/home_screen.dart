...
class KanbanTaskManagerCX extends StatefulWidget {
  final String? processName;

  const KanbanTaskManagerCX({super.key, this.processName});

  @override
  State<KanbanTaskManagerCX> createState() => _KanbanTaskManagerState();
}

class _KanbanTaskManagerState extends State<KanbanTaskManagerCX> {
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (_) => DSIScreen(processName: widget.processName,),
              ),
            );
          },
        ),
            ...
            onSelected: (String value) {
              if (value == 'cronograma') {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => PlannerScreenCX(processName: widget.processName),
                  ),
                );
              } else if (value == 'panel') {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => PanelTrelloCX(processName: widget.processName),
                  ),
                );
                ...
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => KanbanTaskManagerCX(processName: widget.processName),
                  ),
                );
              }
            },
