...
class PlannerScreenCX extends StatefulWidget {
  final String? processName;

  const PlannerScreenCX({super.key, this.processName});

  @override
  State<PlannerScreenCX> createState() => _PlannerScreenState();
}

class _PlannerScreenState extends State<PlannerScreenCX> {
              ...
              if (value == 'cronograma') {
                Navigator.pushReplacement(
                  ...
                  MaterialPageRoute(
                    builder:
                        (context) =>
                            PlannerScreenCX(processName: widget.processName),
                  ),
                );
              } else if (value == 'panel') {
                Navigator.pushReplacement(
                  ...
                  MaterialPageRoute(
                    builder:
                        (context) =>
                            PanelTrelloCX(processName: widget.processName),
                  ),
                );
                ...
                Navigator.pushReplacement(
                  ...
                  MaterialPageRoute(
                    builder:
                        (context) =>
                            KanbanTaskManagerCX(processName: widget.processName),
                  ),
                );
              }
            },
