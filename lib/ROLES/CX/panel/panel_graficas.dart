...
class PanelTrelloCX extends StatefulWidget {
  final String? processName;
  const PanelTrelloCX({Key? key, this.processName}) : super(key: key);

  @override
  _PanelTrelloState createState() => _PanelTrelloState();
}

class _PanelTrelloState extends State<PanelTrelloCX> {
