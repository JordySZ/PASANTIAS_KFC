...
class ProjectsTableCX extends StatefulWidget {
  final List<Project3> projects;
  ...
  @override
  State<ProjectsTableCX> createState() => _ProjectsTableState();
}
class AppData {
  // Campos estáticos para almacenar los datos
  static List<Project3>? projects;
...
class _ProjectsTableState extends State<ProjectsTableCX> {
  ...
  @override
  void didUpdateWidget(ProjectsTableCX oldWidget) {
...
AppData.errorMessage = widget.errorMessage;
  ...
  void _showEditProjectDialog(BuildContext context, Project3 project) {
    final Color backgroundColor = Colors.white;
    final Color textColor = Colors.black;
    final Color darkGrey = Colors.grey[700]!;
    final Color primaryColor = Colors.red[900]!;
