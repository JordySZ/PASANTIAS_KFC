...
import 'op.dart';
class ProjectsTableOpe extends StatefulWidget {
  ...
  @override
  State<ProjectsTableOpe> createState() => _ProjectsTableState();
}
class AppData {
  // Campos estáticos para almacenar los datos
  static List<Project2>? projects;
...
class _ProjectsTableState extends State<ProjectsTableOpe> {
  ...
  @override
  void didUpdateWidget(ProjectsTableOpe oldWidget) {
  ...
  leading: IconButton(
    ...
    onPressed: () {
      Navigator.pushAndRemoveUntil(
        context,
        MaterialPageRoute(builder: (context) => DashboardPage22()),
...
AppData.errorMessage = widget.errorMessage;
                                          ...
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                              builder: (context) => TableroScreen22(
  ...
  void _showEditProjectDialog(BuildContext context, Project2 project) {
    final Color backgroundColor = Colors.white;
    final Color textColor = Colors.black;
    final Color darkGrey = Colors.grey[700]!;
    final Color primaryColor = Colors.red[900]!;
