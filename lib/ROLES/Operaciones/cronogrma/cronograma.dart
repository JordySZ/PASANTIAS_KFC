...
class PlannerScreenOP extends StatefulWidget {
  final String? processName;

  const PlannerScreenOP({super.key, this.processName});

  @override
  State<PlannerScreenOP> createState() => _PlannerScreenState();
}

class _PlannerScreenState extends State<PlannerScreenOP> {
              ...
              if (value == 'cronograma') {
                Navigator.pushReplacement(
                  ...
                  MaterialPageRoute(
                    builder:
                        (context) =>
                            PlannerScreenOP(processName: widget.processName),
                  ),
                );
              } else if (value == 'panel') {
                Navigator.pushReplacement(
                  ...
                  MaterialPageRoute(
                    builder:
                        (context) =>
                            PanelTrelloOp(processName: widget.processName),
                  ),
                );
                ...
                Navigator.pushReplacement(
                  ...
                  MaterialPageRoute(
                    builder:
                        (context) =>
                            KanbanTaskManagerOp(processName: widget.processName),
                  ),
                );
              }
            },
