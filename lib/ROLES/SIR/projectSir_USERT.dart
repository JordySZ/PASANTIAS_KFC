...
import 'sir.dart';
class ProjectsSIR_USER extends StatefulWidget {
  final List<ProjectSIR> projects;
  ...
  @override
  State<ProjectsSIR_USER> createState() => _ProjectsTableState();
}
class AppData {
  // Campos estáticos para almacenar los datos
  static List<ProjectSIR>? projects;
...
class _ProjectsTableState extends State<ProjectsSIR_USER> {
  ...
  @override
  void didUpdateWidget(ProjectsSIR_USER oldWidget) {
...
AppData.errorMessage = widget.errorMessage;
  ...
  void _showEditProjectDialog(BuildContext context, ProjectSIR project) {
    final Color backgroundColor = Colors.white;
    final Color textColor = Colors.black;
    final Color darkGrey = Colors.grey[700]!;
    final Color primaryColor = Colors.red[900]!;
