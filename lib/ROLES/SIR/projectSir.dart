...
import 'sir.dart';
class ProjectsSIR extends StatefulWidget {
  final List<Project7> projects;
  ...
  @override
  State<ProjectsSIR> createState() => _ProjectsTableState();
}
class AppData {
  // Campos estáticos para almacenar los datos
  static List<Project7>? projects;
...
class _ProjectsTableState extends State<ProjectsSIR> {
  ...
  @override
  void didUpdateWidget(ProjectsSIR oldWidget) {
...
AppData.errorMessage = widget.errorMessage;
  ...
  void _showEditProjectDialog(BuildContext context, Project7 project) {
    final Color backgroundColor = Colors.white;
    final Color textColor = Colors.black;
    final Color darkGrey = Colors.grey[700]!;
    final Color primaryColor = Colors.red[900]!;
