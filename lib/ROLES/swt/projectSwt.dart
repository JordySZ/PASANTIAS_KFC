...
import 'sw.dart';
class ProjectsSwt extends StatefulWidget {
  final List<Project8> projects;
  ...
  @override
  State<ProjectsSwt> createState() => _ProjectsTableState();
}
class AppData {
  // Campos estáticos para almacenar los datos
  static List<Project8>? projects;
...
class _ProjectsTableState extends State<ProjectsSwt> {
  ...
  @override
  void didUpdateWidget(ProjectsSwt oldWidget) {
...
AppData.errorMessage = widget.errorMessage;
  ...
  void _showEditProjectDialog(BuildContext context, Project8 project) {
    final Color backgroundColor = Colors.white;
    final Color textColor = Colors.black;
    final Color darkGrey = Colors.grey[700]!;
    final Color primaryColor = Colors.red[900]!;
