...
import 'sw.dart';
class ProjectsSwt_usert extends StatefulWidget {
  final List<ProjectSwt> projects;
  ...
  @override
  State<ProjectsSwt_usert> createState() => _ProjectsTableState();
}
class AppData {
  // Campos estáticos para almacenar los datos
  static List<ProjectSwt>? projects;
...
class _ProjectsTableState extends State<ProjectsSwt_usert> {
  ...
  @override
  void didUpdateWidget(ProjectsSwt_usert oldWidget) {
  ...
  leading: IconButton(
    ...
    onPressed: () {
      Navigator.pushAndRemoveUntil(
        context,
        MaterialPageRoute(builder: (context) => DashboardSwt_usert()),
...
AppData.errorMessage = widget.errorMessage;
  ...
  void _showEditProjectDialog(BuildContext context, ProjectSwt project) {
    final Color backgroundColor = Colors.white;
    final Color textColor = Colors.black;
    final Color darkGrey = Colors.grey[700]!;
    final Color primaryColor = Colors.red[900]!;
