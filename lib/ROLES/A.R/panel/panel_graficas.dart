...
class PanelTrelloAR extends StatefulWidget {
  final String? processName;
  const PanelTrelloAR({Key? key, this.processName}) : super(key: key);

  @override
  _PanelTrelloState createState() => _PanelTrelloState();
}

class _PanelTrelloState extends State<PanelTrelloAR> {
