...
class PlannerScreenAR extends StatefulWidget {
  final String? processName;

  const PlannerScreenAR({super.key, this.processName});

  @override
  State<PlannerScreenAR> createState() => _PlannerScreenState();
}

class _PlannerScreenState extends State<PlannerScreenAR> {
              ...
              if (value == 'cronograma') {
                Navigator.pushReplacement(
                  ...
                  MaterialPageRoute(
                    builder:
                        (context) =>
                            PlannerScreenAR(processName: widget.processName),
                  ),
                );
              } else if (value == 'panel') {
                Navigator.pushReplacement(
                ...
                Navigator.pushReplacement(
                  ...
                  MaterialPageRoute(
                    builder:
                        (context) =>
                            KanbanTaskManagerAR(processName: widget.processName),
                  ),
                );
              }
            },
