...
class KanbanTaskManagerAR extends StatefulWidget {
  final String? processName;

  const KanbanTaskManagerAR({super.key, this.processName});

  @override
  State<KanbanTaskManagerAR> createState() => _KanbanTaskManagerState();
}

class _KanbanTaskManagerState extends State<KanbanTaskManagerAR> {
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (_) => ARTScreen(processName: widget.processName,),
              ),
            );
          },
        ),
            ...
            onSelected: (String value) {
              if (value == 'cronograma') {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => PlannerScreenAR(processName: widget.processName),
                  ),
                );
              } else if (value == 'panel') {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => PanelTrelloAR(processName: widget.processName),
                  ),
                );
                ...
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => KanbanTaskManagerAR(processName: widget.processName),
                  ),
                );
              }
            },
