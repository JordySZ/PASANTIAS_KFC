...
class DashboardAr extends StatefulWidget {
  const DashboardAr({super.key});

  @override
  State<DashboardAr> createState() => _DashboardPageState();
}

class _DashboardPageState extends State<DashboardAr> {
  final ValueNotifier<String?> processStatusNotifier = ValueNotifier<String?>(null);
  Timer? _completionCheckerTimer;
  List<Project4> _completedProjectsToNotify = [];
  ...
  void _onItemTapped(int index) {
    ...
    switch (index) {
      ...
      case 1:
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => UsuariosScreenAR()),
        );
        break;
      ...
      case 3:
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => SolicitudAperturaScreen(),
          ),
        );
        break;
      case 5:
