...
class DashboardSD extends StatefulWidget {
  ...
  @override
  State<DashboardSD> createState() => _DashboardPageState();
}

class _DashboardPageState extends State<DashboardSD> {
  ...
  void _onItemTapped(int index) {
    ...
    switch (index) {
      ...
      case 1:
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => UsuariosScreenSD_USER()),
        );
        break;
  ...
  Widget _buildPageContent(int index) {
    switch (index) {
      ...
      case 1: return UsuariosScreenSD_USER();
