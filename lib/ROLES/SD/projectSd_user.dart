...
class ProjectsSd extends StatefulWidget {
  ...
  @override
  State<ProjectsSd> createState() => _ProjectsTableState();
}
class AppData {
  // Campos estáticos para almacenar los datos
  static List<Projectsd>? projects;
...
class _ProjectsTableState extends State<ProjectsSd> {
  ...
  @override
  void didUpdateWidget(ProjectsSd oldWidget) {
  ...
  leading: IconButton(
    ...
    onPressed: () {
      Navigator.pushAndRemoveUntil(
        context,
        MaterialPageRoute(builder: (context) => DashboardSD_user()),
...
AppData.errorMessage = widget.errorMessage;
  ...
  void _showEditProjectDialog(BuildContext context, Projectsd project) {
    final Color backgroundColor = Colors.white;
    final Color textColor = Colors.black;
    final Color darkGrey = Colors.grey[700]!;
    final Color primaryColor = Colors.red[900]!;
