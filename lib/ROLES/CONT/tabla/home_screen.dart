...
class KanbanTaskManagerCont extends StatefulWidget {
  final String? processName;

  const KanbanTaskManagerCont({super.key, this.processName});

  @override
  State<KanbanTaskManagerCont> createState() => _KanbanTaskManagerState();
}

class _KanbanTaskManagerState extends State<KanbanTaskManagerCont> {
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (_) => CONTScreen(processName: widget.processName,),
              ),
            );
          },
        ),
            ...
            onSelected: (String value) {
              if (value == 'cronograma') {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => PlannerScreenCont(processName: widget.processName),
                  ),
                );
              } else if (value == 'panel') {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => PanelTrelloCont(processName: widget.processName),
                  ),
                );
                ...
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => KanbanTaskManagerCont(processName: widget.processName),
                  ),
                );
              }
            },
