...
class PlannerScreenCont extends StatefulWidget {
  final String? processName;

  const PlannerScreenCont({super.key, this.processName});

  @override
  State<PlannerScreenCont> createState() => _PlannerScreenState();
}

class _PlannerScreenState extends State<PlannerScreenCont> {
              ...
              if (value == 'cronograma') {
                Navigator.pushReplacement(
                  ...
                  MaterialPageRoute(
                    builder:
                        (context) =>
                            PlannerScreenCont(processName: widget.processName),
                  ),
                );
              } else if (value == 'panel') {
                Navigator.pushReplacement(
                  ...
                  MaterialPageRoute(
                    builder:
                        (context) =>
                            PanelTrelloCont(processName: widget.processName),
                  ),
                );
                ...
                Navigator.pushReplacement(
                  ...
                  MaterialPageRoute(
                    builder:
                        (context) =>
                            KanbanTaskManagerCont(processName: widget.processName),
                  ),
                );
              }
            },
