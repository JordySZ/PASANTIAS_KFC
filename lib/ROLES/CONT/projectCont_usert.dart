...
import 'cont_usert.dart';


class ProjectsCONT extends StatefulWidget {
  final List<Projectcont_usert> projects;
  ...
  @override
  State<ProjectsCONT> createState() => _ProjectsTableState();
}
class AppData {
  // Campos estáticos para almacenar los datos
  static List<Projectcont_usert>? projects;
...
class _ProjectsTableState extends State<ProjectsCONT> {
  ...
  @override
  void didUpdateWidget(ProjectsCONT oldWidget) {
  ...
  leading: IconButton(
    ...
    onPressed: () {
      Navigator.pushAndRemoveUntil(
        context,
        MaterialPageRoute(builder: (context) => DashboardCont_user()),
