...
class PanelTrelloCont extends StatefulWidget {
  final String? processName;
  const PanelTrelloCont({Key? key, this.processName}) : super(key: key);

  @override
  _PanelTrelloState createState() => _PanelTrelloState();
}

class _PanelTrelloState extends State<PanelTrelloCont> {
